class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        LaptopStore laptopStore = new LaptopStore();/* write your code here */
...
class LaptopStore extends LaptopFactory {
    ...
    Laptop createLaptop(String type) {
        switch (type) {
            case "13 inch":
                return new Laptop13("13 inch Laptop");/* write your code here */
            case "15 inch":
                return new Laptop15("15 inch Laptop");/* write your code here */
            case "17 inch":
                return new Laptop17("17 inch Laptop");/* write your code here */
            default:
                return null;
        }
    }
